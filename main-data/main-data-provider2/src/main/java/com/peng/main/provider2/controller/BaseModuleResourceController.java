package com.peng.main.provider2.controller;
...
import com.peng.main.provider2.service.BaseModuleResourceService;
import com.peng.main.provider2.service.BaseRoleModuleService;
...
public class BaseModuleResourceController extends CrudController<BaseModuleResources, BaseModuleResourcesRequest> implements BaseModuleResourcesRemoteService{
    ...
    public ResponseData<List<BaseModuleResources>> getCurrentMenu() {
        System.out.println("--------------/menu----------provider2-------------------------------"+accessTokenUtils.getMenuInfo());
